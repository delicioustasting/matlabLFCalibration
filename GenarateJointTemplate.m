...
%}
%%%============
function RawImgTemplate = GenarateJointTemplate(centerStack_h, lineStack_output, k_h, radius,...
    pixelHeight, pixelWidth)
RawImgTemplate = zeros(pixelHeight,pixelWidth);
for i = 1:k_h
    ...
    for x_p = -radius-1:1:radius+1
            for y_p = -radius-1:1:radius+1
                ...
                if (((X_coords -XGrid_coords)*(X_coords -XGrid_coords)...
                    ...
                    RawImgTemplate(Y_coords, X_coords) = template(y_p+radius+1,x_p+radius+1);                  
                end
            end
    end
end
